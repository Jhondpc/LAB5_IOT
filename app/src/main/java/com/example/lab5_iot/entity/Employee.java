...
public class Employee {
    ...
    public Employee(int employeeId, String firstName, String lastName, String email, String phoneNumber, Timestamp hireDate, String jobId, BigDecimal salary, BigDecimal commissionPct, Integer managerId, Integer departmentId, byte meeting, Timestamp meetingDate, String employeeFeedback) {
